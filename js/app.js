...
// 監聽滑鼠移動來更新雷射點的座標，使用 transform 效能更好！
document.addEventListener('mousemove', (e) => {
    if (isLaserMode) {
        // -8px 是為了讓 16px 的圓點中心正好對準鼠標尖端
